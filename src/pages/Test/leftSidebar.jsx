        ...
        <ul className="side-nav">
              ...
              <ul className="side-nav-second-level">
                ...
                <li>
                  <Link to="apps-projects-gantt.html">
                    Gantt
                    <span className="badge rounded-pill badge-light-lighten text-light font-10 float-end">
                      New
                    </span>
                  </Link>
                </li>
                <li>
                  <Link to="apps-projects-add.html">
                    Create Project
          ...
          <li className="side-nav-item">
            <Link to="landing.html" target="_blank" className="side-nav-link">
              ...
              <span className="badge bg-light text-dark float-end">New</span>
              <span> Landing </span>
            </Link>
          </li>
          ...
          <li className="side-nav-item">
            ...
            <div className="collapse" id="sidebarLayouts">
              <ul className="side-nav-second-level">
                <li>
                  <Link to="index-2.html">Horizontal</Link>
                </li>
                <li>
                  <Link to="layouts-vertical.html">Vertical</Link>
                </li>
                <li>
